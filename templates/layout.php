...
<head>
    <meta charset="UTF-8">
    <title><?=replace_specialchars($page_title); ?></title>
...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <form class="main-header__search" method="get" action="/search.php" autocomplete="off">
            <input type="search" name="search" placeholder="Поиск лота" value="<?=replace_specialchars(getFillVal('search', 'get')); ?>">
        ...
        <nav class="user-menu">
            <?php if (isset($_SESSION['user'])): ?>
                <div class="user-menu__logged">
                    <p><?=replace_specialchars($_SESSION['user']['user_name'])?></p>
    ...
    <nav class="nav">
      <ul class="nav__list container">
        ...
        <li class="nav__item">
          <a href="all-lots.html"><?=replace_specialchars($item['cat_name'])?></a>
        </li>
        <?php endforeach; ?>
      </ul>
    </nav>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            <?php foreach($categories_arr as $item): ?>
                <li class="nav__item">
                    <a href="pages/all-lots.html"><?=replace_specialchars($item['cat_name']);?></a>
                </li>
            <?php endforeach; ?>
        </ul>
    </nav>
