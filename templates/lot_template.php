          ...
          <div class="lot-item__state">
            ...
            <div class="lot-item__cost-state">
              <div class="lot-item__rate">
                ...
                <span class="lot-item__cost"><?=price_format(clear_spec($bet_price))?></span>
              </div>
              <div class="lot-item__min-cost">
                Мин. ставка <span><?=price_format(clear_spec($bet_price + $row_lot['step_bet']))?></span>
              </div>
            </div>
            <form class="lot-item__form" action="https://echo.htmlacademy.ru" method="post" autocomplete="off">
              <p class="lot-item__form-item form__item form__item--invalid">
                <label for="cost">Ваша ставка</label>
                <input id="cost" type="text" name="cost" placeholder="<?=price_format(clear_spec($bet_price + $row_lot['step_bet']))?>">
